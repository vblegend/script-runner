...
var EsayEval = /** @class */ (function () {
     ...
     * @returns 函数对象
     */
     EsayEval.buildFunction = function (script, argNames, thisContext, globalContext) {
     ...
     * @returns
     */
     EsayEval.eval = function (script, params, thisContext, globalContext) {
        if (params == null)
            params = {};
